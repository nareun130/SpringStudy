package com.nareun.rest.webservices.restfulwebservices.exception;
...
public class CustomizedResponseEntityException extends ResponseEntityExceptionHandler {
    ...
    // * 어떤 예외를 다룰 건지 설정 */
    @ExceptionHandler(Exception.class) // ~> 여기선 모든 Exception을 다룬다.
    ...
    @ExceptionHandler(UserNotFoundException.class) // ~> 여기선 모든 Exception을 다룬다.
